...
if (empty($hora)) {
	echo "<script> alert('Debes seleccionar una hora para bloquearla.'); window.location='../bloqueoHoras.html' </script>";
	exit;
}
...
if (mysqli_query($conn, $sqlgrabar)) {
	echo "<script> alert('Hora bloqueada con exito: el $fecha a las $hora'); window.location='../bloqueoHoras.html' </script>";
}
