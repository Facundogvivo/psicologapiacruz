...
if (mysqli_query($conexion, $sql)) {
  ...
  echo "
    ...
    <meta http-equiv='refresh'
        content='0;url=https://facundogonzalezvivo.cl/proyectos/psicologapiacruz/php/pago_exitoso_online.php'>
    </head>
        ...
        <div class='about'>
          <div class='text'>
            <div id='detalle_reserva'>
              ...
              <p style='text-align: center;'>{$reserva['nombre']}, tu consulta online ha sido agendada con éxito</p>
